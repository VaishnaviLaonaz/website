...
//             But it doesn’t have to be this way. LAONAZ brings farmers,
  ...
  return (
    <main className="legal-page bounded">
      <section className="legal-hero">
        <p className="legal-kicker">ABOUT LAONAZ</p>
        <h1>Growing together through shared knowledge.</h1>
        <p>
          Laonaz is a simple educational blogging community for people who care
          about farming, sustainability, local knowledge, and practical learning.
          It is a place to read, write, discuss, and learn from community
          experiences in a respectful way.
        </p>
      </section>

      <section className="legal-content">
        <div className="legal-block">
          <h2>1. What Laonaz is</h2>
          <p>
            Laonaz is a community-based platform where members can share articles,
            stories, observations, and useful ideas related to farming and rural
            learning. The goal is to make knowledge easier to find, easier to
            read, and easier to discuss.
          </p>
        </div>

        <div className="legal-block">
          <h2>2. Why we created Laonaz</h2>
          <p>
            Farming knowledge is often shared through conversations, personal
            experience, videos, and scattered online posts. Laonaz brings that
            learning into one organized space where people can explore topics,
            save useful posts, and support each other through simple discussion.
          </p>
        </div>

        <div className="legal-block">
          <h2>3. How you can use the website</h2>
          <p>
            You can read articles, write blogs, comment on posts, follow other
            members, bookmark useful content, and take part in community learning.
            Every post should be written with the intention to inform, explain,
            ask, or help.
          </p>
        </div>

        <div className="legal-block">
          <h2>4. What members can write about</h2>
          <p>
            Members can write about farming experiences, crop observations,
            sustainability ideas, local practices, tools, resources, challenges,
            community stories, and learning notes. Content should be clear,
            respectful, and useful for readers.
          </p>
        </div>

        <div className="legal-block">
          <h2>5. Comments and community help</h2>
          <p>
            Comments are meant for questions, suggestions, appreciation, and
            helpful discussion. Members should avoid rude language, spam,
            personal attacks, misleading claims, or sharing private information.
            A good comment should make the discussion clearer or more useful.
          </p>
        </div>

        <div className="legal-block">
          <h2>6. Our approach to information</h2>
          <p>
            Laonaz is an educational blogging platform, not a replacement for
            professional, legal, financial, medical, or technical advice. Content
            shared by members may be based on personal experience or general
            learning. Readers should use their own judgment before applying any
            information in real situations.
          </p>
        </div>

        <div className="legal-block">
          <h2>7. Data and trust</h2>
          <p>
            We use account information only to support website features such as
            login, profiles, articles, comments, bookmarks, likes, and community
            interactions. We do not sell personal user data. Public actions such
            as articles, comments, usernames, and visible profile details may be
            shown because they are part of the community experience.
          </p>
        </div>

        <div className="legal-block">
          <h2>8. Our community goal</h2>
          <p>
            Our goal is to build a calm, useful, and respectful space where
            farming-related knowledge can be shared in simple language. Laonaz
            works best when people write honestly, ask clearly, and help each
            other learn.
          </p>
        </div>
        ...
        <div className="legal-footer-note">
          <p>
            Want to participate?{" "}
            <Link to="/login">Join the community</Link> or start by reading our{" "}
