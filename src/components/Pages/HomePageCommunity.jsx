...
//above one code workking fine before cost cutting
...
export default function Home() {
   ...
   * New: useArticles(12)
   *
   * This page displays 8 latest articles and top engaged articles.
   * Loading 50 on homepage is unnecessary and increases RTDB downloads.
   */
  const articles = useArticles(12);
  ...
  return (
    <main style={{ background: "var(--clr-field-mist)" }} className="pb-5">
      ...
      <section className="py-5" style={{ background: "var(--clr-field-mist)" }}>
        <MDBContainer fluid className="bounded px-3 px-sm-4 px-lg-4">
          <MDBRow className="gx-2 gx-md-3 gx-lg-4 gy-4 gx-lg-4">
            ...
            >
              <div>
                <h1 className="u-h1 text-heading fw-normal">
                  Growing{" "}
                  <span style={{ color: "#5C6B3C", fontWeight: 600 }}>
                    Together:
                  </span>{" "}
                ...
                <div className="mt-4">
                  <div className="fw-semibold u-caption">#Welcome</div>
                  ...
                  <div className="d-flex align-items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="u-caption text-muted">
                        Stands With Farmers
                      </div>
                    </div>
                  </div>
            ...
            <MDBCol
              ...
              sm="10"
              xs="12"
              className="p-0 mx-md-auto mx-sm-auto px-lg-5 px-md-4 px-sm-3"
            >
              <div>
                <img
                  src={homepageImg}
      ...
      <section className="py-5" style={{ background: "var(--clr-field-mist)" }}>
        <MDBContainer fluid className="bounded px-3 px-sm-4 px-lg-5">
          <h4 className="u-h3 mb-5 text-heading">Latest Articles</h4>
      ...
      <section className="py-2">
        <MDBContainer fluid className="bounded px-lg-5">
          <h4 className="u-h3 mb-5 text-heading">
            Most Engaged Articles This Month
          </h4>

          {topLiked.length ? (
            <MDBRow className="gx-2 gx-md-3 gy-4 g-0 g-lg-4 gx-lg-5">
              {topLiked.map((article) => (
                <MDBCol lg="4" md="6" key={article.id}>
                  <ArticleCard
                    article={article}
                    author={authors[article.authorId]}
                  />
